export default function About() {
  return (
    <div className="py-52 px-4 max-w-6xl mx-auto text-start">
      <h1 className="text-3xl font-bold mb-4 text-[#3C474B]">
        About Havencrest Estate
      </h1>
      <p className="mb-4 text-[#162521]">
        Havencrest Estate is a leading real estate agency that specializes in
